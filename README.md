...
[![tag](https://img.shields.io/github/tag/samber/lo.svg)](https://github.com/asuratu/lo/releases)
![Go Version](https://img.shields.io/badge/Go-%3E%3D%201.18-%23007d9c)
[![GoDoc](https://godoc.org/github.com/asuratu/lo?status.svg)](https://pkg.go.dev/github.com/asuratu/lo)
![Build Status](https://github.com/asuratu/lo/actions/workflows/test.yml/badge.svg)
[![Go report](https://goreportcard.com/badge/github.com/asuratu/lo)](https://goreportcard.com/report/github.com/asuratu/lo)
[![Coverage](https://img.shields.io/codecov/c/github/samber/lo)](https://codecov.io/gh/samber/lo)
[![Contributors](https://img.shields.io/github/contributors/samber/lo)](https://github.com/asuratu/lo/graphs/contributors)
...
```sh
go get github.com/asuratu/lo@v1
```
...
```go
import (
    "github.com/asuratu/lo"
    lop "github.com/asuratu/lo/parallel"
)
```
...
GoDoc: [https://godoc.org/github.com/asuratu/lo](https://godoc.org/github.com/asuratu/lo)
...
```go
import lop "github.com/asuratu/lo/parallel"
...
```go
import lo "github.com/asuratu/lo"
...
⚠️ This helper is **mutable**. This behavior might change in `v2.0.0`. See [#160](https://github.com/asuratu/lo/issues/160).
...
PASS
ok  	github.com/asuratu/lo	6.657s
```
...
- Fork the [project](https://github.com/asuratu/lo)
- Fix [open issues](https://github.com/asuratu/lo/issues) or request new features
